...
$labels = array(
    "es" => array(
        ...
        "downloadlink" => glob("pdf/cv_josep_sanz_spanish_preview-*.png"),
    ...
    "en" => array(
        ...
        "downloadlink" => glob("pdf/cv_josep_sanz_english_preview-*.png"),
        "downloadlink_ca" => "pdf/cv_josep_sanz_catalan_full.pdf",
        "downloadlink_es" => "pdf/cv_josep_sanz_spanish_full.pdf",
        "downloadlink_en" => "pdf/cv_josep_sanz_english_full.pdf",
    ...
    "ca" => array(
        ...
        "downloadlink" => glob("pdf/cv_josep_sanz_catalan_preview-*.png"),
        "downloadlink_ca" => "pdf/cv_josep_sanz_catalan_full.pdf",
        "downloadlink_es" => "pdf/cv_josep_sanz_spanish_full.pdf",
        "downloadlink_en" => "pdf/cv_josep_sanz_english_full.pdf",
