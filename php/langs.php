...
$labels = array(
    "es" => array(
        ...
        "downloadtext" => "Descargar currículum vitae largo",
        "downloadlink" => "pdf/cv_josep_sanz_spanish_preview.pdf",
        "downloadlink_ca" => "pdf/cv_josep_sanz_catalan_full.pdf",
        "downloadlink_es" => "pdf/cv_josep_sanz_spanish_full.pdf",
        "downloadlink_en" => "pdf/cv_josep_sanz_english_full.pdf",
    ...
    "en" => array(
        ...
        "downloadtext" => "Download full profile",
        "downloadlink" => "pdf/cv_josep_sanz_english_preview.pdf",
        "downloadlink_ca" => "pdf/cv_josep_sanz_catalan_full.pdf",
        "downloadlink_es" => "pdf/cv_josep_sanz_spanish_full.pdf",
        "downloadlink_en" => "pdf/cv_josep_sanz_english_full.pdf",
    ...
    "ca" => array(
        ...
        "downloadtext" => "Descarregar currículum vitae llarg",
        "downloadlink" => "pdf/cv_josep_sanz_catalan_preview.pdf",
        "downloadlink_ca" => "pdf/cv_josep_sanz_catalan_full.pdf",
        "downloadlink_es" => "pdf/cv_josep_sanz_spanish_full.pdf",
        "downloadlink_en" => "pdf/cv_josep_sanz_english_full.pdf",
